...
# Binary Options (Surgery, Radiation, Lung.metastasis, Bone.metastasis)
BINARY_MAP = {
    "No": 0, "Yes": 1
}
    ...
    try:
        ...
        if hasattr(model, 'feature_names_in_'):
            ...
            feature_names = [
                ...
                "Grade.recode", "T.stage", "Bone.metastasis",
...
with st.sidebar.form("patient_data_form"):
    ...
    with col_b1:
        bone_label = st.selectbox("Bone Metastasis", options=list(BINARY_MAP.keys()))
    with col_b2:
...
if submit_button:
    ...
    input_dict = {
        ...
        "Bone.metastasis": BINARY_MAP[bone_label],
        ...
        try:
            with st.spinner("Calculating feature contributions..."):
                ...
                **Chart Interpretation:**
                ...
                - 🟦 **Blue bars**: Factors pushing risk **downward** (e.g. smaller tumor).
